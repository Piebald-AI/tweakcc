...
const PATCH_DEFINITIONS = [
  ...
  },
  {
    ...
    group: PatchGroup.ALWAYS_APPLIED,
    description:
      'Set CLAUDE_CODE_CONTEXT_LIMIT env var to change 200k max for custom models',
    appliesTo: 'both',
  },
  {
  ...
  },
  {
    ...
    group: PatchGroup.ALWAYS_APPLIED,
    description:
      'Use "Opus Plan 1M" model: Opus for planning, Sonnet 1M context for building',
    appliesTo: 'both',
  },
  {
  ...
  },
  {
    ...
    group: PatchGroup.MISC_CONFIGURABLE,
    description: 'Thinking blocks outputted by model will show without Ctrl+O',
    appliesTo: 'both',
  },
  {
  ...
  },
  {
    ...
    group: PatchGroup.MISC_CONFIGURABLE,
    description:
      'Round displayed token counts to nearest multiple of chosen value',
    appliesTo: 'both',
  },
  {
    id: 'remember-skill',
    ...
    group: PatchGroup.MISC_CONFIGURABLE,
    description:
      'Register built-in "/remember" skill to review session memories and update CLAUDE.local.md',
    appliesTo: 'both',
  },
  {
    id: 'agents-md',
  ...
  },
  {
    ...
    group: PatchGroup.MISC_CONFIGURABLE,
    description:
      'Automatically accept plans without "Ready to code?" confirmation prompt',
    appliesTo: 'both',
  },
  {
  ...
  },
  {
    ...
    group: PatchGroup.MISC_CONFIGURABLE,
    description: 'Suppress native installer warning message at startup',
    appliesTo: 'cli',
  },
  {
    id: 'increase-file-read-limit',
  ...
  },
  {
    ...
    name: 'MCP batch size',
    group: PatchGroup.FEATURES,
    description: 'Change number of MCP servers started in parallel',
    appliesTo: 'cli',
  },
  {
    ...
    group: PatchGroup.FEATURES,
    description: 'User messages in chat history will be styled',
    appliesTo: 'both',
  },
  {
...
export const applyCliPatches = applyCustomization;
